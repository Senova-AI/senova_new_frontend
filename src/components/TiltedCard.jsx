    ...
    >
      ...
      >
        ...
        {displayOverlayContent && overlayContent && (
          <motion.div className="absolute top-0 left-0 z-[2] text-xl font-bold will-change-transform [transform:translateZ(30px)]">
            {overlayContent}
          </motion.div>
        )}
      </motion.div>
      ...
      >
        <div className="flex flex-row items-center justify-center gap-6">
          <a
            ...
            className="text-[#dedede] hover:text-[#0077b5] transition-colors"
            aria-label="LinkedIn"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#dedede] hover:text-[#1da1f2] transition-colors"
